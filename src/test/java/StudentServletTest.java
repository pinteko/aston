...
//    private static DataAccessObjectImpl dataAccessObjectImpl;
...
//        dataAccessObjectImpl = mock(DataAccessObjectImpl.class);
...
//            studentServlet.setDao(dataAccessObjectImpl);
//        }
//
...
//
//        verify(dataAccessObjectImpl).addStudent(anyString(), anyInt(), anyInt());
//    }
//}
